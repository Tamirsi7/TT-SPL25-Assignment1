...
public:
     ...
     *                              // both wrappers think they own the pointer. they both will try to delete it and we will get double deletion
     */
     ...
     * What should happen to the source wrapper after the move?                    // should be pointed at null.
     */
